...
namespace PlayFabInternal
{
    ...
    void PlayFabMultiplayerAPI::EnablePartiesForTitle(
    ...
    void PlayFabMultiplayerAPI::OnEnablePartiesForTitleResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabMultiplayerAPI::GetCognitiveServicesLocales(
    ...
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            OnGetCognitiveServicesLocalesResult,
            customData));
    ...
    void PlayFabMultiplayerAPI::OnGetCognitiveServicesLocalesResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabMultiplayerAPI::GetCognitiveServicesToken(
    ...
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            OnGetCognitiveServicesTokenResult,
            customData));
    ...
    void PlayFabMultiplayerAPI::OnGetCognitiveServicesTokenResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabMultiplayerAPI::OnListBuildSummariesResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabMultiplayerAPI::OnListQosServersResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabMultiplayerAPI::RequestParty(
    ...
    void PlayFabMultiplayerAPI::OnRequestPartyResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
