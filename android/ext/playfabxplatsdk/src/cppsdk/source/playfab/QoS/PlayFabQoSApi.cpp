...
using namespace std;
using namespace PlayFabInternal::MultiplayerModels;
using namespace PlayFabInternal::EventsModels;
...
namespace PlayFabInternal
{
    namespace QoS
    {
        ...
        void PlayFabQoSApi::SendResultsToPlayFab(const QoSResult& result)
        {
            ...
            PlayFabInternal::EventsModels::WriteEventsRequest request;
            PlayFabInternal::EventsModels::EventContents eventContents;
