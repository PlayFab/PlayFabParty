...
namespace PlayFabInternal
{
    namespace AdminModels
    {
        ...
        inline void ToJsonEnum(const GenericErrorCodes input, Json::Value& output)
        {
            ...
            if (input == GenericErrorCodesEmailTemplateInvalidSyntax) output = Json::Value("EmailTemplateInvalidSyntax");
            if (input == GenericErrorCodesEmailTemplateMissingCallback) output = Json::Value("EmailTemplateMissingCallback");
            if (input == GenericErrorCodesPushNotificationTemplateInvalidPayload) output = Json::Value("PushNotificationTemplateInvalidPayload");
            if (input == GenericErrorCodesInvalidLocalizedPushNotificationLanguage) output = Json::Value("InvalidLocalizedPushNotificationLanguage");
            if (input == GenericErrorCodesMissingLocalizedPushNotificationMessage) output = Json::Value("MissingLocalizedPushNotificationMessage");
            if (input == GenericErrorCodesPushNotificationTemplateMissingPlatformPayload) output = Json::Value("PushNotificationTemplateMissingPlatformPayload");
            if (input == GenericErrorCodesPushNotificationTemplatePayloadContainsInvalidJson) output = Json::Value("PushNotificationTemplatePayloadContainsInvalidJson");
            if (input == GenericErrorCodesPushNotificationTemplateContainsInvalidIosPayload) output = Json::Value("PushNotificationTemplateContainsInvalidIosPayload");
            if (input == GenericErrorCodesPushNotificationTemplateContainsInvalidAndroidPayload) output = Json::Value("PushNotificationTemplateContainsInvalidAndroidPayload");
            if (input == GenericErrorCodesPushNotificationTemplateIosPayloadMissingNotificationBody) output = Json::Value("PushNotificationTemplateIosPayloadMissingNotificationBody");
            if (input == GenericErrorCodesPushNotificationTemplateAndroidPayloadMissingNotificationBody) output = Json::Value("PushNotificationTemplateAndroidPayloadMissingNotificationBody");
            if (input == GenericErrorCodesPushNotificationTemplateNotFound) output = Json::Value("PushNotificationTemplateNotFound");
            ...
            if (input == GenericErrorCodesCatalogEntityInvalid) output = Json::Value("CatalogEntityInvalid");
            if (input == GenericErrorCodesCatalogTitleIdMissing) output = Json::Value("CatalogTitleIdMissing");
            if (input == GenericErrorCodesCatalogPlayerIdMissing) output = Json::Value("CatalogPlayerIdMissing");
            if (input == GenericErrorCodesCatalogClientIdentityInvalid) output = Json::Value("CatalogClientIdentityInvalid");
            if (input == GenericErrorCodesCatalogOneOrMoreFilesInvalid) output = Json::Value("CatalogOneOrMoreFilesInvalid");
            if (input == GenericErrorCodesCatalogItemMetadataInvalid) output = Json::Value("CatalogItemMetadataInvalid");
        ...
        inline void FromJsonEnum(const Json::Value& input, GenericErrorCodes& output)
        {
            ...
            if (inputStr == "EmailTemplateInvalidSyntax") output = GenericErrorCodesEmailTemplateInvalidSyntax;
            if (inputStr == "EmailTemplateMissingCallback") output = GenericErrorCodesEmailTemplateMissingCallback;
            if (inputStr == "PushNotificationTemplateInvalidPayload") output = GenericErrorCodesPushNotificationTemplateInvalidPayload;
            if (inputStr == "InvalidLocalizedPushNotificationLanguage") output = GenericErrorCodesInvalidLocalizedPushNotificationLanguage;
            if (inputStr == "MissingLocalizedPushNotificationMessage") output = GenericErrorCodesMissingLocalizedPushNotificationMessage;
            if (inputStr == "PushNotificationTemplateMissingPlatformPayload") output = GenericErrorCodesPushNotificationTemplateMissingPlatformPayload;
            if (inputStr == "PushNotificationTemplatePayloadContainsInvalidJson") output = GenericErrorCodesPushNotificationTemplatePayloadContainsInvalidJson;
            if (inputStr == "PushNotificationTemplateContainsInvalidIosPayload") output = GenericErrorCodesPushNotificationTemplateContainsInvalidIosPayload;
            if (inputStr == "PushNotificationTemplateContainsInvalidAndroidPayload") output = GenericErrorCodesPushNotificationTemplateContainsInvalidAndroidPayload;
            if (inputStr == "PushNotificationTemplateIosPayloadMissingNotificationBody") output = GenericErrorCodesPushNotificationTemplateIosPayloadMissingNotificationBody;
            if (inputStr == "PushNotificationTemplateAndroidPayloadMissingNotificationBody") output = GenericErrorCodesPushNotificationTemplateAndroidPayloadMissingNotificationBody;
            if (inputStr == "PushNotificationTemplateNotFound") output = GenericErrorCodesPushNotificationTemplateNotFound;
            ...
            if (inputStr == "CatalogEntityInvalid") output = GenericErrorCodesCatalogEntityInvalid;
            if (inputStr == "CatalogTitleIdMissing") output = GenericErrorCodesCatalogTitleIdMissing;
            if (inputStr == "CatalogPlayerIdMissing") output = GenericErrorCodesCatalogPlayerIdMissing;
            if (inputStr == "CatalogClientIdentityInvalid") output = GenericErrorCodesCatalogClientIdentityInvalid;
            if (inputStr == "CatalogOneOrMoreFilesInvalid") output = GenericErrorCodesCatalogOneOrMoreFilesInvalid;
            if (inputStr == "CatalogItemMetadataInvalid") output = GenericErrorCodesCatalogItemMetadataInvalid;
        ...
        struct CloudScriptAzureFunctionsTaskParameter : public PlayFabBaseModel
        {
            Json::Value Argument;
            std::string FunctionName;

            CloudScriptAzureFunctionsTaskParameter() :
                PlayFabBaseModel(),
                Argument(),
                FunctionName()
            {}

            CloudScriptAzureFunctionsTaskParameter(const CloudScriptAzureFunctionsTaskParameter& src) :
                PlayFabBaseModel(),
                Argument(src.Argument),
                FunctionName(src.FunctionName)
            {}

            ~CloudScriptAzureFunctionsTaskParameter() = default;
        ...
        struct CloudScriptAzureFunctionsTaskSummary : public PlayFabBaseModel
        {
            Boxed<time_t> CompletedAt;
            Boxed<double> EstimatedSecondsRemaining;
            Boxed<double> PercentComplete;
            Boxed<ExecuteFunctionResult> Result;
            std::string ScheduledByUserId;
            time_t StartedAt;
            Boxed<TaskInstanceStatus> Status;
            Boxed<NameIdentifier> TaskIdentifier;
            ...
            CloudScriptAzureFunctionsTaskSummary() :
                PlayFabBaseModel(),
                CompletedAt(),
                EstimatedSecondsRemaining(),
                PercentComplete(),
            ...
            CloudScriptAzureFunctionsTaskSummary(const CloudScriptAzureFunctionsTaskSummary& src) :
                PlayFabBaseModel(),
                CompletedAt(src.CompletedAt),
                EstimatedSecondsRemaining(src.EstimatedSecondsRemaining),
                PercentComplete(src.PercentComplete),
            ...
            ~CloudScriptAzureFunctionsTaskSummary() = default;
        ...
        struct CreateCloudScriptAzureFunctionsTaskRequest : public PlayFabRequestCommon
        {
            std::string Description;
            bool IsActive;
            std::string Name;
            CloudScriptAzureFunctionsTaskParameter Parameter;
            std::string Schedule;
            ...
            CreateCloudScriptAzureFunctionsTaskRequest(const CreateCloudScriptAzureFunctionsTaskRequest& src) :
                PlayFabRequestCommon(),
                Description(src.Description),
                IsActive(src.IsActive),
                Name(src.Name),
            ...
            ~CreateCloudScriptAzureFunctionsTaskRequest() = default;
        ...
        struct GetCloudScriptAzureFunctionsTaskInstanceResult : public PlayFabResultCommon
        {
            Boxed<CloudScriptAzureFunctionsTaskParameter> Parameter;
            Boxed<CloudScriptAzureFunctionsTaskSummary> Summary;
            ...
            GetCloudScriptAzureFunctionsTaskInstanceResult(const GetCloudScriptAzureFunctionsTaskInstanceResult& src) :
                PlayFabResultCommon(),
                Parameter(src.Parameter),
                Summary(src.Summary)
            {}

            ~GetCloudScriptAzureFunctionsTaskInstanceResult() = default;
