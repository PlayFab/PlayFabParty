...
namespace PlayFabInternal
{
    ...
    public:
        ...
        void SetAvatarUrl(ProfilesModels::SetAvatarUrlRequest& request, const ProcessApiCallback<ProfilesModels::SetAvatarUrlResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void SetDisplayName(ProfilesModels::SetDisplayNameRequest& request, const ProcessApiCallback<ProfilesModels::SetDisplayNameResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnSetAvatarUrlResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        void OnSetDisplayNameResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
