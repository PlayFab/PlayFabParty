...
namespace PlayFabInternal
{
    ...
    public:
        ...
        void SetAvatarUrl(ProfilesModels::SetAvatarUrlRequest& request, ProcessApiCallback<ProfilesModels::SetAvatarUrlResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void SetDisplayName(ProfilesModels::SetDisplayNameRequest& request, ProcessApiCallback<ProfilesModels::SetDisplayNameResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnSetAvatarUrlResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnSetDisplayNameResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
