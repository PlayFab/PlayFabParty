...
namespace PlayFabInternal
{
    ...
    private:
        ...
        static void OnAuthUserResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnPlayerJoinedResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnPlayerLeftResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnStartGameResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUserInfoResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
