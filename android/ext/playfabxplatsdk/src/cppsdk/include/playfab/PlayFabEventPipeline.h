...
namespace PlayFabInternal
{
    ...
    public:
        ...
        // BUMBLELION: Add a way for us to initialize a PlayFabEventPipelineSettings object to reference instances of 
        ...
        PlayFabEventPipelineSettings(PlayFabEventPipelineType emitType, const std::shared_ptr<PlayFabAuthenticationContext>& authenticationContext, bool useBackgroundThread);
        PlayFabEventPipelineSettings(PlayFabEventPipelineType emitType, const std::shared_ptr<PlayFabApiSettings>& apiSettings, const std::shared_ptr<PlayFabAuthenticationContext>& authenticationContext, bool useBackgroundThread);
        ...
        // BUMBLELION: Add a shared_ptr to a PlayFabApiSettings object for storing an instanced version of API settings
        // in line with the rest of the instanced API's in PlayFab
