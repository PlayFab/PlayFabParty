...
namespace PlayFabInternal
{
    ...
    public:
        ...
        static void EnablePartiesForTitle(MultiplayerModels::EnablePartiesForTitleRequest& request, const ProcessApiCallback<MultiplayerModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetCognitiveServicesLocales(MultiplayerModels::GetCognitiveServicesLocalesRequest& request, const ProcessApiCallback<MultiplayerModels::GetCognitiveServicesLocalesResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        static void GetCognitiveServicesToken(MultiplayerModels::GetCognitiveServicesTokenRequest& request, const ProcessApiCallback<MultiplayerModels::GetCognitiveServicesTokenResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetMultiplayerServerAndToken(MultiplayerModels::GetMultiplayerServerAndTokenRequest& request, const ProcessApiCallback<MultiplayerModels::GetMultiplayerServerAndTokenResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void RequestMultiplayerServerAndToken(MultiplayerModels::RequestMultiplayerServerAndTokenRequest& request, const ProcessApiCallback<MultiplayerModels::RequestMultiplayerServerAndTokenResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        static void RequestParty(MultiplayerModels::RequestPartyRequest& request, const ProcessApiCallback<MultiplayerModels::RequestPartyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
    ...
    private:
        ...
        static void OnEnablePartiesForTitleResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnGetCognitiveServicesLocalesResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        static void OnGetCognitiveServicesTokenResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnGetMultiplayerServerAndTokenResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnRequestMultiplayerServerAndTokenResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        static void OnRequestPartyResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
