...
namespace PlayFabInternal
{
    ...
    public:
        ...
        static void ConsumePSNEntitlements(ClientModels::ConsumePSNEntitlementsRequest& request, ProcessApiCallback<ClientModels::ConsumePSNEntitlementsResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetAdPlacements(ClientModels::GetAdPlacementsRequest& request, ProcessApiCallback<ClientModels::GetAdPlacementsResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetPlayFabIDsFromPSNAccountIDs(ClientModels::GetPlayFabIDsFromPSNAccountIDsRequest& request, ProcessApiCallback<ClientModels::GetPlayFabIDsFromPSNAccountIDsResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void LinkPSNAccount(ClientModels::LinkPSNAccountRequest& request, ProcessApiCallback<ClientModels::LinkPSNAccountResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void LoginWithPSN(ClientModels::LoginWithPSNRequest& request, ProcessApiCallback<ClientModels::LoginResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void RefreshPSNAuthToken(ClientModels::RefreshPSNAuthTokenRequest& request, ProcessApiCallback<ClientModels::EmptyResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void ReportAdActivity(ClientModels::ReportAdActivityRequest& request, ProcessApiCallback<ClientModels::ReportAdActivityResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void RewardAdActivity(ClientModels::RewardAdActivityRequest& request, ProcessApiCallback<ClientModels::RewardAdActivityResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void UnlinkPSNAccount(ClientModels::UnlinkPSNAccountRequest& request, ProcessApiCallback<ClientModels::UnlinkPSNAccountResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
    ...
    private:
        ...
        static void OnAcceptTradeResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnAddOrUpdateContactEmailResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnAddUsernamePasswordResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnAndroidDevicePushNotificationRegistrationResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnAttributeInstallResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnCancelTradeResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnConfirmPurchaseResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnConsumeItemResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnConsumePSNEntitlementsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnConsumeXboxEntitlementsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetAccountInfoResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetAdPlacementsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetCurrentGamesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetFriendLeaderboardAroundPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetFriendsListResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetGameServerRegionsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetLeaderboardAroundPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetPaymentTokenResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetPhotonAuthenticationTokenResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetPlayerTradesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetPlayFabIDsFromGameCenterIDsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetPlayFabIDsFromGoogleIDsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetPlayFabIDsFromKongregateIDsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetPlayFabIDsFromTwitchIDsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetPurchaseResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetTitlePublicKeyResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetTradeStatusResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetWindowsHelloChallengeResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnLinkAndroidDeviceIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkCustomIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkFacebookAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkFacebookInstantGamesIdResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkGameCenterAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkGoogleAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkIOSDeviceIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkKongregateResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkNintendoSwitchDeviceIdResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkOpenIdConnectResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkPSNAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkSteamAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkTwitchResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkWindowsHelloResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLinkXboxAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithAndroidDeviceIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithCustomIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithEmailAddressResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithFacebookResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithFacebookInstantGamesIdResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithGameCenterResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithGoogleAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithIOSDeviceIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithKongregateResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithNintendoSwitchDeviceIdResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithOpenIdConnectResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithPlayFabResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithPSNResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithSteamResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithTwitchResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithWindowsHelloResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnLoginWithXboxResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnMatchmakeResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnOpenTradeResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnPayForPurchaseResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnPurchaseItemResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRedeemCouponResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRefreshPSNAuthTokenResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRegisterForIOSPushNotificationResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRegisterPlayFabUserResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRegisterWithWindowsHelloResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRemoveContactEmailResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnReportAdActivityResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnReportDeviceInfoResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnReportPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRestoreIOSPurchasesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRewardAdActivityResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnStartPurchaseResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnUnlinkAndroidDeviceIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkCustomIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkFacebookAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkFacebookInstantGamesIdResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkGameCenterAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkGoogleAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkIOSDeviceIDResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkKongregateResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkNintendoSwitchDeviceIdResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkOpenIdConnectResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkPSNAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkSteamAccountResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkTwitchResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnUnlinkWindowsHelloResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnValidateAmazonIAPReceiptResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnValidateGooglePlayPurchaseResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnValidateIOSReceiptResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnValidateWindowsStoreReceiptResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
