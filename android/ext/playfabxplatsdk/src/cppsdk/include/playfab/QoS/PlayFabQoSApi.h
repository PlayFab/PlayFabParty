...
namespace PlayFabInternal
{
    namespace QoS
    {
        ...
        private:
            std::vector<PlayFabInternal::MultiplayerModels::AzureRegion> GetPingList(unsigned int serverCount);
            void InitializeAccumulatedPingResults(std::unordered_map<PlayFabInternal::MultiplayerModels::AzureRegion, PingResult>& accumulatedPingResults);
            ...
            void PingServers(std::vector<PlayFabInternal::MultiplayerModels::AzureRegion>& pings, std::vector<std::future<PingResult>>& asyncPingResults, std::vector<std::shared_ptr<QoSSocket>>& sockets, std::unordered_map<PlayFabInternal::MultiplayerModels::AzureRegion, PingResult>& accumulatedPingResults, unsigned int timeoutMs);
            void UpdateAccumulatedPingResult(PingResult& result, PlayFabInternal::MultiplayerModels::AzureRegion region, std::unordered_map<PlayFabInternal::MultiplayerModels::AzureRegion, PingResult>& accumulatedPingResults, unsigned int timeoutMs);
        ...
        private:
            ...
            std::unordered_map<PlayFabInternal::MultiplayerModels::AzureRegion, std::string> regionMap;
