...
typedef enum PARTY_CHAT_PERMISSION_OPTIONS
{
    ...
    PARTY_CHAT_PERMISSION_OPTIONS_SEND_AUDIO = 0x0001,
    PARTY_CHAT_PERMISSION_OPTIONS_RECEIVE_AUDIO = 0x0002,
    PARTY_CHAT_PERMISSION_OPTIONS_RECEIVE_TEXT = 0x0004,
...
{
    uint32_t /*PARTYSTATECHANGETYPE*/ stateChangeType;
} PARTY_STATE_CHANGE;
