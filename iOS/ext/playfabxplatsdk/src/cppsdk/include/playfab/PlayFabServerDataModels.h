...
namespace PlayFabInternal
{
    namespace ServerModels
    {
        ...
        struct LoginGameServerWithCustomIdRequest : public PlayFabRequestCommon
        {
            std::map<std::string, std::string> CustomTags;
            std::string CustomId;

            LoginGameServerWithCustomIdRequest() :
                PlayFabRequestCommon(),
                CustomTags(),
                CustomId()
            {}

            LoginGameServerWithCustomIdRequest(const LoginGameServerWithCustomIdRequest& src) :
                PlayFabRequestCommon(),
                CustomTags(src.CustomTags),
                CustomId(src.CustomId)
            {}

            ~LoginGameServerWithCustomIdRequest() = default;
        ...
        struct GameServerLoginResult : public PlayFabLoginResultCommon
        {
            Boxed<EntityKey> GameServerEntity;
            std::string GameServerEntityToken;
            Boxed<time_t> TokenExpiration;

            GameServerLoginResult() :
                PlayFabLoginResultCommon(),
                GameServerEntity(),
                GameServerEntityToken(),
                TokenExpiration()
            {}

            GameServerLoginResult(const GameServerLoginResult& src) :
                PlayFabLoginResultCommon(),
                GameServerEntity(src.GameServerEntity),
                GameServerEntityToken(src.GameServerEntityToken),
                TokenExpiration(src.TokenExpiration)
            {}

            ~GameServerLoginResult() = default;

            void FromJson(const Json::Value& input) override
            {
                FromJsonUtilO(input["GameServerEntity"], GameServerEntity);
                FromJsonUtilS(input["GameServerEntityToken"], GameServerEntityToken);
                FromJsonUtilT(input["TokenExpiration"], TokenExpiration);
            }
            ...
            {
                Json::Value output;
                Json::Value each_GameServerEntity; ToJsonUtilO(GameServerEntity, each_GameServerEntity); output["GameServerEntity"] = each_GameServerEntity;
                Json::Value each_GameServerEntityToken; ToJsonUtilS(GameServerEntityToken, each_GameServerEntityToken); output["GameServerEntityToken"] = each_GameServerEntityToken;
                Json::Value each_TokenExpiration; ToJsonUtilT(TokenExpiration, each_TokenExpiration); output["TokenExpiration"] = each_TokenExpiration;
                return output;
            }
        };
