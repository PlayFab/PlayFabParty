...
namespace PlayFabInternal
{
    ...
    public:
        ...
        static void LoginGameServerWithCustomId(ServerModels::LoginGameServerWithCustomIdRequest& request, const ProcessApiCallback<ServerModels::GameServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
    ...
    private:
        ...
        static void OnLoginGameServerWithCustomIdResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
