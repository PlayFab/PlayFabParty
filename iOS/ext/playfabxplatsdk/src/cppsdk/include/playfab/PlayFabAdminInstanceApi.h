...
namespace PlayFabInternal
{
    ...
    public:
        ...
        void CreateCloudScriptAzureFunctionsTask(AdminModels::CreateCloudScriptAzureFunctionsTaskRequest& request, const ProcessApiCallback<AdminModels::CreateTaskResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetCloudScriptAzureFunctionsTaskInstance(AdminModels::GetTaskInstanceRequest& request, const ProcessApiCallback<AdminModels::GetCloudScriptAzureFunctionsTaskInstanceResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetEventSinks(AdminModels::GetEventSinksRequest& request, const ProcessApiCallback<AdminModels::GetEventSinksResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void SetEventSinks(AdminModels::SetEventSinksRequest& request, const ProcessApiCallback<AdminModels::SetEventSinksResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnCreateCloudScriptAzureFunctionsTaskResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnGetCloudScriptAzureFunctionsTaskInstanceResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnGetEventSinksResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnSetEventSinksResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
