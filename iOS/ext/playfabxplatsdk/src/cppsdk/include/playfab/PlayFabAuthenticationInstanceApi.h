...
namespace PlayFabInternal
{
    ...
    public:
        ...
        void OnActivateKeyResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCreateKeyResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnDeactivateKeyResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnDeleteKeyResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetEntityTokenResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetKeysResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
