...
namespace PlayFabInternal
{
    ...
    public:
        ...
        static void CancelAllServerBackfillTicketsForPlayer(MultiplayerModels::CancelAllServerBackfillTicketsForPlayerRequest& request, ProcessApiCallback<MultiplayerModels::CancelAllServerBackfillTicketsForPlayerResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void CancelServerBackfillTicket(MultiplayerModels::CancelServerBackfillTicketRequest& request, ProcessApiCallback<MultiplayerModels::CancelServerBackfillTicketResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void CreateServerBackfillTicket(MultiplayerModels::CreateServerBackfillTicketRequest& request, ProcessApiCallback<MultiplayerModels::CreateServerBackfillTicketResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void EnablePartiesForTitle(MultiplayerModels::EnablePartiesForTitleRequest& request, ProcessApiCallback<MultiplayerModels::EmptyResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetCognitiveServicesToken(MultiplayerModels::GetCognitiveServicesTokenRequest& request, ProcessApiCallback<MultiplayerModels::GetCognitiveServicesTokenResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetMultiplayerServerLogs(MultiplayerModels::GetMultiplayerServerLogsRequest& request, ProcessApiCallback<MultiplayerModels::GetMultiplayerServerLogsResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetServerBackfillTicket(MultiplayerModels::GetServerBackfillTicketRequest& request, ProcessApiCallback<MultiplayerModels::GetServerBackfillTicketResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetTitleMultiplayerServersQuotas(MultiplayerModels::GetTitleMultiplayerServersQuotasRequest& request, ProcessApiCallback<MultiplayerModels::GetTitleMultiplayerServersQuotasResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void ListQosServersForTitle(MultiplayerModels::ListQosServersForTitleRequest& request, ProcessApiCallback<MultiplayerModels::ListQosServersForTitleResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        static void ListServerBackfillTicketsForPlayer(MultiplayerModels::ListServerBackfillTicketsForPlayerRequest& request, ProcessApiCallback<MultiplayerModels::ListServerBackfillTicketsForPlayerResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void RequestParty(MultiplayerModels::RequestPartyRequest& request, ProcessApiCallback<MultiplayerModels::RequestPartyResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
    ...
    private:
        ...
        static void OnCancelAllServerBackfillTicketsForPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnCancelServerBackfillTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnCreateRemoteUserResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnCreateServerBackfillTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnEnablePartiesForTitleResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetCognitiveServicesTokenResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetMatchmakingQueueResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnGetMultiplayerServerDetailsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetMultiplayerServerLogsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetQueueStatisticsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetRemoteLoginEndpointResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetServerBackfillTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetTitleEnabledForMultiplayerServersStatusResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetTitleMultiplayerServersQuotasResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnListContainerImageTagsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnListMatchmakingQueuesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnListMatchmakingTicketsForPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnListMultiplayerServersResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnListQosServersResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnListQosServersForTitleResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnListServerBackfillTicketsForPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnListVirtualMachineSummariesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnRemoveMatchmakingQueueResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnRequestPartyResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        static void OnSetMatchmakingQueueResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
