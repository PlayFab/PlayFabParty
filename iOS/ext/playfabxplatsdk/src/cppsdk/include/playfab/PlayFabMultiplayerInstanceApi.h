...
namespace PlayFabInternal
{
    ...
    public:
        ...
        void EnablePartiesForTitle(MultiplayerModels::EnablePartiesForTitleRequest& request, const ProcessApiCallback<MultiplayerModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetCognitiveServicesLocales(MultiplayerModels::GetCognitiveServicesLocalesRequest& request, const ProcessApiCallback<MultiplayerModels::GetCognitiveServicesLocalesResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void GetCognitiveServicesToken(MultiplayerModels::GetCognitiveServicesTokenRequest& request, const ProcessApiCallback<MultiplayerModels::GetCognitiveServicesTokenResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetMultiplayerServerAndToken(MultiplayerModels::GetMultiplayerServerAndTokenRequest& request, const ProcessApiCallback<MultiplayerModels::GetMultiplayerServerAndTokenResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void RequestMultiplayerServerAndToken(MultiplayerModels::RequestMultiplayerServerAndTokenRequest& request, const ProcessApiCallback<MultiplayerModels::RequestMultiplayerServerAndTokenResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void RequestParty(MultiplayerModels::RequestPartyRequest& request, const ProcessApiCallback<MultiplayerModels::RequestPartyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnEnablePartiesForTitleResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnGetCognitiveServicesLocalesResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        void OnGetCognitiveServicesTokenResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnGetMultiplayerServerAndTokenResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnRequestMultiplayerServerAndTokenResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        void OnRequestPartyResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
