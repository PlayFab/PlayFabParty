...
namespace PlayFabInternal
{
    ...
    public:
        ...
        void CancelAllServerBackfillTicketsForPlayer(MultiplayerModels::CancelAllServerBackfillTicketsForPlayerRequest& request, ProcessApiCallback<MultiplayerModels::CancelAllServerBackfillTicketsForPlayerResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void CancelServerBackfillTicket(MultiplayerModels::CancelServerBackfillTicketRequest& request, ProcessApiCallback<MultiplayerModels::CancelServerBackfillTicketResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void CreateServerBackfillTicket(MultiplayerModels::CreateServerBackfillTicketRequest& request, ProcessApiCallback<MultiplayerModels::CreateServerBackfillTicketResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void EnablePartiesForTitle(MultiplayerModels::EnablePartiesForTitleRequest& request, ProcessApiCallback<MultiplayerModels::EmptyResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetCognitiveServicesToken(MultiplayerModels::GetCognitiveServicesTokenRequest& request, ProcessApiCallback<MultiplayerModels::GetCognitiveServicesTokenResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetMultiplayerServerLogs(MultiplayerModels::GetMultiplayerServerLogsRequest& request, ProcessApiCallback<MultiplayerModels::GetMultiplayerServerLogsResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetServerBackfillTicket(MultiplayerModels::GetServerBackfillTicketRequest& request, ProcessApiCallback<MultiplayerModels::GetServerBackfillTicketResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetTitleMultiplayerServersQuotas(MultiplayerModels::GetTitleMultiplayerServersQuotasRequest& request, ProcessApiCallback<MultiplayerModels::GetTitleMultiplayerServersQuotasResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void ListQosServersForTitle(MultiplayerModels::ListQosServersForTitleRequest& request, ProcessApiCallback<MultiplayerModels::ListQosServersForTitleResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void ListServerBackfillTicketsForPlayer(MultiplayerModels::ListServerBackfillTicketsForPlayerRequest& request, ProcessApiCallback<MultiplayerModels::ListServerBackfillTicketsForPlayerResult> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void RequestParty(MultiplayerModels::RequestPartyRequest& request, ProcessApiCallback<MultiplayerModels::RequestPartyResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnCancelAllMatchmakingTicketsForPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCancelAllServerBackfillTicketsForPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCancelMatchmakingTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCancelServerBackfillTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCreateBuildWithCustomContainerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCreateBuildWithManagedContainerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCreateMatchmakingTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCreateRemoteUserResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCreateServerBackfillTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnCreateServerMatchmakingTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnDeleteAssetResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnDeleteBuildResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnDeleteCertificateResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnDeleteRemoteUserResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnEnableMultiplayerServersForTitleResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnEnablePartiesForTitleResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetAssetUploadUrlResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetBuildResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetCognitiveServicesTokenResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetContainerRegistryCredentialsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetMatchResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetMatchmakingQueueResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetMatchmakingTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetMultiplayerServerDetailsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetMultiplayerServerLogsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetQueueStatisticsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetRemoteLoginEndpointResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetServerBackfillTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetTitleEnabledForMultiplayerServersStatusResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnGetTitleMultiplayerServersQuotasResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnJoinMatchmakingTicketResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListArchivedMultiplayerServersResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListAssetSummariesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListBuildSummariesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListCertificateSummariesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListContainerImagesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListContainerImageTagsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListMatchmakingQueuesResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        void OnListQosServersForTitleResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnListServerBackfillTicketsForPlayerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        void OnRemoveMatchmakingQueueResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        ...
        void OnRequestPartyResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnRolloverContainerRegistryCredentialsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnSetMatchmakingQueueResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnShutdownMultiplayerServerResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnUpdateBuildRegionsResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        void OnUploadCertificateResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
