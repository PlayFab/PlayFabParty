...
namespace PlayFabInternal
{
    ...
    public:
        ...
        static void SetAvatarUrl(ProfilesModels::SetAvatarUrlRequest& request, ProcessApiCallback<ProfilesModels::SetAvatarUrlResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        static void SetDisplayName(ProfilesModels::SetDisplayNameRequest& request, ProcessApiCallback<ProfilesModels::SetDisplayNameResponse> callback, ErrorCallback errorCallback = nullptr, void* customData = nullptr);
    ...
    private:
        ...
        static void OnSetAvatarUrlResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
        static void OnSetDisplayNameResult(int httpCode, std::string result, std::shared_ptr<CallRequestContainerBase> reqContainer);
