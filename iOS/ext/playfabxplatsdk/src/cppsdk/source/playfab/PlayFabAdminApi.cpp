...
namespace PlayFabInternal
{
    ...
    void PlayFabAdminAPI::OnAddServerBuildResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabAdminAPI::CreateCloudScriptAzureFunctionsTask(
        CreateCloudScriptAzureFunctionsTaskRequest& request,
        const ProcessApiCallback<CreateTaskResult> callback,
        const ErrorCallback errorCallback,
        void* customData
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            OnCreateCloudScriptAzureFunctionsTaskResult,
            customData));
    ...
    void PlayFabAdminAPI::OnCreateCloudScriptAzureFunctionsTaskResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabAdminAPI::GetCloudScriptAzureFunctionsTaskInstance(
        GetTaskInstanceRequest& request,
        const ProcessApiCallback<GetCloudScriptAzureFunctionsTaskInstanceResult> callback,
        const ErrorCallback errorCallback,
        void* customData
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            OnGetCloudScriptAzureFunctionsTaskInstanceResult,
            customData));

        reqContainer->successCallback = std::shared_ptr<void>((callback == nullptr) ? nullptr : new ProcessApiCallback<GetCloudScriptAzureFunctionsTaskInstanceResult>(callback));
        reqContainer->errorCallback = errorCallback;
    ...
    void PlayFabAdminAPI::OnGetCloudScriptAzureFunctionsTaskInstanceResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);

        GetCloudScriptAzureFunctionsTaskInstanceResult outResult;
        if (ValidateResult(outResult, container))
        {
            ...
            if (internalPtr != nullptr)
            {
                const auto callback = (*static_cast<ProcessApiCallback<GetCloudScriptAzureFunctionsTaskInstanceResult> *>(internalPtr));
                callback(outResult, container.GetCustomData());
            }
        }
    }
    ...
    void PlayFabAdminAPI::OnGetServerBuildInfoResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabAdminAPI::OnGetServerBuildUploadUrlResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabAdminAPI::OnListServerBuildsResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabAdminAPI::OnModifyMatchmakerGameModesResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabAdminAPI::OnRemoveServerBuildResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
