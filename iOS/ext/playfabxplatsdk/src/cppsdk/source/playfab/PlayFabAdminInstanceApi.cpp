...
namespace PlayFabInternal
{
    ...
    void PlayFabAdminInstanceAPI::CreateCloudScriptAzureFunctionsTask(
    ...
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            std::bind(&PlayFabAdminInstanceAPI::OnCreateCloudScriptAzureFunctionsTaskResult, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3),
            customData,
            this->settings));
    ...
    void PlayFabAdminInstanceAPI::OnCreateCloudScriptAzureFunctionsTaskResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabAdminInstanceAPI::GetCloudScriptAzureFunctionsTaskInstance(
        GetTaskInstanceRequest& request,
    ...
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            std::bind(&PlayFabAdminInstanceAPI::OnGetCloudScriptAzureFunctionsTaskInstanceResult, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3),
            customData,
            this->settings));
    ...
    void PlayFabAdminInstanceAPI::OnGetCloudScriptAzureFunctionsTaskInstanceResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
