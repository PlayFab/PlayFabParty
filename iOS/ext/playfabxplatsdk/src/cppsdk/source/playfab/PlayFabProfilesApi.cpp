...
namespace PlayFabInternal
{
    ...
    void PlayFabProfilesAPI::SetAvatarUrl(
    ...
    void PlayFabProfilesAPI::OnSetAvatarUrlResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
    ...
    void PlayFabProfilesAPI::SetDisplayName(
    ...
    void PlayFabProfilesAPI::OnSetDisplayNameResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
